...
.center[
```{r,echo=FALSE,out.width="500px"}
knitr::include_graphics("img/Ramp2_1.PNG")
```

```{r,echo=FALSE,out.width="500px"}
knitr::include_graphics("img/Ramp2_3.png")
```
]
]
...
- Informative plots showing pathway overlap clustering results
]
...
.right-column[
.small[
- Tested nine different formulas for known positive pathways lists in terms of coverage and size

- Examined results using raw and Holm-adjusted p value

- In three scenarios post Holm adjustment, MetaboSPAN improved median recall rate
...
.left-column[
.small[
| Background | Test           | Cohort 1 | Cohort 2 | **Overlap** |
|------------|----------------|----------|----------|---------|
...
### 1. MetaboSPAN can improve the reproducibility and sensitivity of Fisher's results, with a cost to specificity
...
- p53-null cell lines have been shown to withstand sterol deprived
  conditions better than wild-type
